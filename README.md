...
Здесь содержатся материалы курса по Web3, на котором было разобрано написание смарт-контрактов на языке Go для платформы Neo N3. 

Конспект лекций находится в файле [Terminal_commands.odt](https://github.com/Almaxana/Web3/blob/main/Terminal_commands.odt)
Смарт-контракты, написанные на лекциях, находятся в папках каталога [contracts](https://github.com/Almaxana/Web3/tree/main/contracts), за исключением папки [auction](https://github.com/Almaxana/Web3/tree/main/contracts/auction). Там лежит код dApp, которое было написано в качестве итогового проекта по этому курсу.
